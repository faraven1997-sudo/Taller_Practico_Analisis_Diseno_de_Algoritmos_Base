...
por cada fila de manera casi ilimitada hasta dar con la busqueda este proceso pasa en milisegundos no obstante solo aplicaria para elemtento existente dentro
...
no bstante se pueden llegar a presentar errores de sintaxys en la matriz a la hora de ejecutar, pero al momento de organizarlo en las aplicaciones este se puede
modificar.
# ejemplo estructura 

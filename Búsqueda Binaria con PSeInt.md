...
se puede evidenciar que dentro del algoritmo este contempla varias variables antes de dar con el numero o valor busacdo, de esta forma este puede proceso puede pasar
